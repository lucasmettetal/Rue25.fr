    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-10 flex items-center justify-between h-[68px]">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button
              ...
              aria-label="Menu"
            >
              <span className={`block w-5 h-px bg-dark transition-transform duration-200 ${menuOpen ? 'translate-y-[6px] rotate-45' : ''}`} />
              <span className={`block w-5 h-px bg-dark transition-opacity duration-200 ${menuOpen ? 'opacity-0' : ''}`} />
              <span className={`block w-5 h-px bg-dark transition-transform duration-200 ${menuOpen ? '-translate-y-[6px] -rotate-45' : ''}`} />
            </button>
          </div>
        </div>
      ...
      <section className="relative h-[78vh] overflow-hidden flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 pb-10 md:pb-16 w-full fade-up">
          ...
          <p className="text-[13px] md:text-[15px] text-white/70 max-w-md leading-relaxed mb-9">
    ...
    <div className="fade-up cursor-pointer" style={{ animationDelay: `${index * 55}ms` }}
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-stone mb-3 md:mb-4">
        ...
        {hovered && product.in_stock && (
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-dark text-white text-[11px] tracking-[0.12em] uppercase px-5 py-2 whitespace-nowrap hidden md:block">
            Voir le produit
          </div>
        )}
      </div>
